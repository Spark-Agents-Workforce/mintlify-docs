...
split recipe-per-page under `platform-v2/` (groups: Setup · Live for New Orders · Migrate,
the last built from the Notion "Migrate Easily" cookbook). The original Platform tab stays
